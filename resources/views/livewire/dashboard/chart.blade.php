    ...
    <div class="row col d-flex align-items-end mb-70">
        <div class="col-auto d-flex align-items-center">
            <svg class="icon icon-Forest-ERB me-3" width="48" height="48">
                <use href="{{asset('img/icons.svg#'.$icon)}}"></use>
        ...
        <div class="ms-auto col-auto">
            <div class="btn-group btn-row" role="group" aria-label="Basic example">
                <button type="button" wire:click="$emit('certificate-selected',['{{ $sellCertificateId }}','14'])" class="btn fiterBtn @if($maxDays == 14) active @endif " data-days="14">2 Weeks</button>
                <button type="button" wire:click="$emit('certificate-selected',['{{ $sellCertificateId }}','30'])" class="btn fiterBtn @if($maxDays == 30) active @endif" data-days="30">1 Month</button>
                <button type="button" wire:click="$emit('certificate-selected',['{{ $sellCertificateId }}','180'])" class="btn fiterBtn @if($maxDays == 180) active @endif" data-days="180">6 Month</button>
                <button type="button" wire:click="$emit('certificate-selected',['{{ $sellCertificateId }}','365'])" class="btn fiterBtn @if($maxDays == 365) active @endif" data-days="365">1 Year</button>
            </div>
        </div>
    </div>
